...
| `setup_windows_startup.ps1` | Task Scheduler + PM2 + MCP | `.\fixes\setup_windows_startup.ps1` |
...
## Claude Code — починить если не запускается

**Подтверждённая причина отказа (22-24.07.2026):**
```
Error from provider(openrouter,qwen/qwen3-235b-a22b:free: 404): This model is unavailable for free
```
...
| 5 | fix_claude_settings.ps1 (smart) | ✅ Готово | `.\fixes\fix_claude_settings.ps1` |
| 6 | fix_claude_env.ps1 | ✅ Готово | `.\fixes\fix_claude_env.ps1` |
| 7 | fix_claude_nuclear.ps1 | ✅ Готово | `.\fixes\fix_claude_nuclear.ps1` |
| 8 | setup_windows_startup.ps1 | ✅ Готово | `.\fixes\setup_windows_startup.ps1` |
| 9 | health_monitor.py | ✅ Готово | авто в deploy.ps1 |
| 10 | telegram_bot.py | ✅ Готово | авто в deploy.ps1 |
| 11 | openrouter_sync.py | ✅ Готово | авто dry-run в deploy.ps1 |
| 12 | env_check.py | ✅ Готово | `python fixes/env_check.py` |
| 13 | mcp_server.py | ✅ Готово | Claude Desktop config |
